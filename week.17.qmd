...
In the lecture, I talk about how we use the linear model to estimate the association between an outcome like mean accuracy of understanding and a predictor like vocabulary knowledge *as the expected change in the average outcome*, given variation in the predictor.
...
```{r}
#| label: fig-ridges
#| fig-cap: "Plots showing the association between the outcome mean accuracy of understanding a predictor, vocabulary knowledge, with the plot on the right modified to show how accuracy of understanding varies between individuals in the sample with the sample vocabularytest scores"
