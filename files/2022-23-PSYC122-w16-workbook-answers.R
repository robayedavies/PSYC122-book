...
# -- Q.5. -- Did you get a message in red in the Console window in R-Studio: 
# what does it say?
...
# -- Task 8 -- Create a scatterplot to examine the association between some 
# variables e.g. 'HLVA' and 'mean.acc'
# -- hint: Task 8 -- We are working with geom_point() and you need x and y 
# aesthetic mappings
...
# -- Task 9 -- Now do scatterplots with *every* numeric predictor variable in 
# the 'study.two.gen' dataset 
# -- hint: Task 9 -- You always want to use as the y-axis variable the 
# outcome 'mean.acc' so: y = mean.acc
# -- hint: Task 9 -- Then you can use each numeric predictor variable 
# as the x-axis variable e.g. x = mean.self

# -- hint: Task 9 -- Remember what we saw with summary(): not every variable 
# consists of numbers  
# -- hint: Task 9 -- If the summary() does not show you a mean for a variable, 
# R does not think that variable is numeric

# -- hint: Task 9 -- It can be hard to decide what an association looks like: 
...
# -- Q.12. -- What is the shape (direction) of the association between 'mean.self' 
# and 'mean.acc'?
# -- A.12. -- Increase in 'mean.self' is associated with increase in 'mean.acc'  
  
# -- Q.13. -- What is the shape (direction) of the association between 'AGE' 
# and 'mean.acc'?
...
# -- hint: Q.18. -- Just like with geom_histogram() there is ggplot reference 
